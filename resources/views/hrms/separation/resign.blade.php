        ...
        <header id="topbar" class="alt">
                ...
                <div class="topbar-left">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-current-item">Resignation</li>
                    </ol>
                </div>
                        ...
                        {{ csrf_field() }}
                            <!-- <div class="wizard steps-bg steps-left"> -->
                                ...
                                <h4 class="wizard-section-title">
                                    <i class="fa fa-user pr5"></i>Resignation   </h4>
...
@endif
                                    ...
                                    <div class="section">
                                        <label for="input002"><h6 class="mb20 mt40"> Notice Period </h6></label>
                                            <select class="select2-single form-control" name="notice_date" id="notice_date">
